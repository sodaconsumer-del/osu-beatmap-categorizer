...
def test_impossible_note_density_is_junk():
    ...
    # 487/sec - an audio visualizer built out of hit objects, not gameplay
    # (see AGENTS.md).
...
def test_cutstream_rejoin_is_rejected_when_the_cut_itself_is_a_jump():
    ...
    # stream with a quietly skipped note. Real example: Night of Knights
    # [TAG4] has cuts up to 6.8x hit-circle diameter between two clusters
    # ~430px apart on the 512px playfield - a genuine jump, not a timing
    # artifact.
...
def test_burst_vs_jump_coverage_uses_matching_denominators_when_available():
    ...
    # counts to near-equality by construction (e.g. burst_note_total=265 vs
    # implied jump_count=262 on one real map), making the old
    # notes-vs-notes comparison essentially
